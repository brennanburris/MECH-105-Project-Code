...
%4/3/2021
% this code is supposed to find the integral of a table of data, except it 
%does not work which really sucks. Use at your own risk. It adds a
%trapezoid rule to the end of the table if the table has an odd number of 
%inputs. 
